        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering learners worldwide with cutting-edge IT courses. Master in-demand skills 
              and advance your career with expert-led training.
            </p>
            <div className="flex gap-3">
              ...
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 bg-gray-800 hover:bg-blue-500 rounded-lg flex items-center justify-center transition-colors cursor-pointer"
                >
                  {social.icon}
                </a>
              ))}
